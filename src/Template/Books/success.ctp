...
<!-- End Navbar -->
<script>alert("Thank You. Your order status is Successfull.");</script>
<div class="wrapper">
<br><br>
<div class="container">
...
<div class="section">
          <div class="container tim-container">
              <div class="title" style="text-align: center;">
                          <p class="text-center title"><?php 
                          echo "<h3>Your order status is ". $book->status ."Booking Id is". $book->booking_id  ."</h3>";
                          echo "<h4>Your transaction id for this transaction is ".$book->txnid.". You may try making the payment by clicking the link below.</h4>";?></p>
                          <br>

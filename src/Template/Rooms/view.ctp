						...
						<div class="card card-raised card-carousel">
							<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
								...
								foreach ($image as $key => $value) { ?>	
									<li data-target="#carousel-example-generic" data-slide-to="<?=h($key)?>" class="<?=h($class)?>"></li>
									<?php $class=''; } ?>
								</ol>
									...
									foreach ($image as $key => $value) { ?>
										<div class="<?=h($class)?>">
											<?=$this->Html->image('rooms/'.$value,['class'=>'img_item'])?>
											...
											<div class="tab-pane" id="book_now">
												...
												<?php echo $this->Form->create('post',array('url' => '/books/payment',$rooms->id)); ?>
													...
													<div class="form-group label-floating">
														...
														<input type="text" class="form-control" name="productinfo" value="<?php echo $rooms->name; ?>" readonly />
													</div>
													<div class="form-group label-static">

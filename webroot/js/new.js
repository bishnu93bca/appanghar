    function validate()
      ...
      if( document.myForm.fname.value == "" )
		 ...
		 if( document.myForm.fname.value.length<5 || document.myForm.fname.value.length>20 )
         {
...
var keystroke = String.fromCharCode
(event.keyCode).toLowerCase();

if (event.ctrlKey && (keystroke == 'c' ||
 keystroke == 'v' || keystroke == 'u'|| keystroke=='s' )) {
alert("Sorry..!! This Not Allowed Here");
